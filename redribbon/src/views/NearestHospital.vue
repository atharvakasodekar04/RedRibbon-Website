<template>
    <div>
        ...
        <div class="mainContainer">
            ...
            <!-- Blood Avaliability Section -->
            <div class="bloodAvl">

                <!-- Heading Section -->
                <div class="headSection">
                    <br>
                    <h3>Nearest Hospital Available</h3>
                </div>
                ...
                <div class="container">
                    ...
                    <div class="formSection">
                        ...
                        <!-- Title tag -->
                        <h4> Hospital <span style="color:#EB3738">Avaliability</span></h4>
                        <br>
                        <form>
...
export default{
    ...
    methods: {
        submit() {
            ...
            axios.get('https://retoolapi.dev/lSZQJo/data')
            .then(response => {
